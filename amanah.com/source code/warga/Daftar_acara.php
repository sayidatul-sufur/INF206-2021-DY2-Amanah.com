                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                                    ...
                                    ?>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="btn" style="background-color: rgb(141, 76, 206);">
                                                    <a href="../Admin/daftarbarang.php?id=<?php echo $d['id']; ?>">
                                                    Lihat
                                                    </a>
                                                    </button>
                                                </td>
                            ...
                            <div class="text-right">
                                <br>
                                <button class="btn" style="background-color: rebeccapurple;">
                                <a href="sumbangkan.php" style="color:white; ">
                                SUMBANGKAN
                                </a>
                                </button>
                            </div>
