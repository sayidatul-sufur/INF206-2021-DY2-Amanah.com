                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="username" class="form-control text-center" style="color: white;" value="<?php echo $d['username']; ?>">

                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <a class="bmd-label-floating">No Hp :</label>

                                                <input type="text" name="no_hp" class="form-control text-center" style="color: white;" value="<?php echo $d['no_hp']; ?>">
