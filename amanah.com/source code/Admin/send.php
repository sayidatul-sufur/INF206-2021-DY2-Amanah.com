...
$email_pengirim = 'naifada123@gmail.com'; // Isikan dengan email pengirim
$nama_pengirim = 'Amanah.com'; // Isikan dengan nama pengirim
foreach ($data as $d) {
    $email_penerima = $d['email'];; // Ambil email penerima dari inputan form

    if ($email_penerima == "") {
        continue;
    }

    $subjek = "Acara Baru!!!"; // Ambil subjek dari inputan form
    $username = $d['username'];
    $pesan = "Hy $username..! " . "<br>" .
        "kami baru menambahkan acara $acara, jika anda tertarik menyumbangkan barang, silahkan mengunjungi halaman website kami :)"; // Ambil pesan dari inputan form
    ...
    $mail->Password = 'jangkrik123'; // Isikan dengan Password email pengirim
    $mail->Port = 465;
    $mail->SMTPAuth = true;
    $mail->SMTPSecure = 'ssl';
...
header("location: ../Admin/DaftarAcaraAdmin.php");
